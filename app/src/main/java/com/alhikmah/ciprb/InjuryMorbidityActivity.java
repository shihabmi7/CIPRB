...
public class InjuryMorbidityActivity extends AppCompatActivity {

    EditText edittext_date_of_injury, edittext_time_of_injury,edittext_number_of_days_work_loss;
