...
public class AndroidDatabaseManager extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new CiprbDatabase.DbHelper(AndroidDatabaseManager.this);
        ...
        help.setText("Click on the row below to update menu or delete the tuple");
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    // a array adapter which add menu to the spinner which helps in user making changes to the table
                                            ...
                                            if (!isFinishing()) {
                                                new AlertDialog.Builder(AndroidDatabaseManager.this)
                                                        ...
                                                        .setPositiveButton("Add",
                                                                new DialogInterface.OnClickListener() {
                                                                    // after entering menu if user clicks on add we take the menu and run a insert query
                                                                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void updateDeletePopup(int row) {
        ...
        //create a layout with text menu which has the column names and
        //edit texts which has the menu of the row which user has selected
                    ...
                    new AlertDialog.Builder(AndroidDatabaseManager.this)
                            ...
                            .setPositiveButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        //this code will be executed when user changes menu of edit text or spinner and clicks on ok button
                                        public void onClick(DialogInterface dialog, int which) {

                                            //get spinner value
                                            String spinner_value = crud_dropdown.getSelectedItem().toString();

                                            //it he spinner value is update this row get the menu from
                                            ...
                                            //it he spinner value is delete this row get the menu from
    ...
    //a static class to save cursor,table menu etc which is used by functions to share data in the program.
